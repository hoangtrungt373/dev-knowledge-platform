 ...
 *
 * <p>The implementation ({@link com.ttg.devknowledgeplatform.social.api.impl.FriendController}) carries
 * no HTTP annotations. User search lives on {@code api}'s {@code UserApi}
 * instead, alongside the other user-profile endpoints.
 */
