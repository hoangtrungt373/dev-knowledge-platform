 ...
 * format, PHP→JSON, JSON→PHP. Shared across every one of those because they genuinely share this
 * shape (raw text in, a minify flag, transformed text out); an operation whose input/output
