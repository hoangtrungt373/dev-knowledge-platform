 ...
 * operations. The implementation ({@link com.ttg.devknowledgeplatform.content.api.impl.QuestionAnswerController})
...
public interface QuestionAnswerApi {
    ...
    /**
     * Creates a new question owned by the authenticated caller.
     *
