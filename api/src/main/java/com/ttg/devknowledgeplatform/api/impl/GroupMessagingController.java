...
import com.ttg.devknowledgeplatform.api.GroupMessagingApi;
...
import com.ttg.devknowledgeplatform.dto.messaging.WsErrorResponse;
import com.ttg.devknowledgeplatform.mapper.MessagingMapper;
import com.ttg.devknowledgeplatform.security.StompAuthChannelInterceptor;
 ...
 * {@code /topic/channels/{channelId}} (membership-gated by {@link StompAuthChannelInterceptor})
 * receives the saved message live instead of having to re-fetch.
 *
