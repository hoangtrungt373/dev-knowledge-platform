 ...
 * {@link SlugService#generateUniqueSlug} with the production {@link ErrorCode#CATEGORY_SLUG_CONFLICT},
...
public class CategorySeeder extends CsvSeeder<Category> {
    ...
    protected Category buildEntity(CSVRecord record) {
        ...
        category.setSlug(slugService.generateUniqueSlug(name, categoryRepository::existsBySlug, ErrorCode.CATEGORY_SLUG_CONFLICT));
