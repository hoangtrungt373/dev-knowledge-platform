 ...
 * {@link SlugService#generateUniqueSlug} with the production {@link ErrorCode#TAG_SLUG_CONFLICT},
...
public class TagSeeder extends CsvSeeder<Tag> {
    ...
    protected Tag buildEntity(CSVRecord record) {
        ...
        tag.setName(name);
        tag.setSlug(slugService.generateUniqueSlug(name, tagRepository::existsBySlug, ErrorCode.TAG_SLUG_CONFLICT));
