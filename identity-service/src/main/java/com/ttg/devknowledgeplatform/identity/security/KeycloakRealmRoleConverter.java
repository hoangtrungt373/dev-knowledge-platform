 ...
 * {@code ecommerce-service}'s converter of the same name rather than shared — this module has no
 * Maven dependency on either, same standalone-deployability reasoning as the rest of this package.
 */
@Component
