...
import com.ttg.devknowledgeplatform.identity.api.OAuth2Api;
...
import com.ttg.devknowledgeplatform.identity.dto.RegisterRequest;
import com.ttg.devknowledgeplatform.identity.dto.UserInfoResponse;
import com.ttg.devknowledgeplatform.identity.dto.auth.ExchangeStateRequest;
import com.ttg.devknowledgeplatform.identity.dto.auth.LoginRequest;
import com.ttg.devknowledgeplatform.identity.dto.auth.LoginResponse;
import com.ttg.devknowledgeplatform.identity.dto.auth.LogoutRequest;
import com.ttg.devknowledgeplatform.identity.dto.auth.RefreshTokenRequest;
import com.ttg.devknowledgeplatform.identity.dto.auth.RegisterResponse;
import com.ttg.devknowledgeplatform.identity.dto.auth.ResendOtpRequest;
import com.ttg.devknowledgeplatform.identity.dto.auth.TokenResponse;
import com.ttg.devknowledgeplatform.identity.dto.auth.VerifyOtpRequest;
...
import com.ttg.devknowledgeplatform.identity.service.EmailService;
import com.ttg.devknowledgeplatform.identity.service.OtpService;
import com.ttg.devknowledgeplatform.identity.security.service.RefreshTokenBlacklistService;
...
public class OAuth2Controller implements OAuth2Api {
    ...
    public ResponseEntity<LoginResponse> exchangeState(ExchangeStateRequest request) {
        ...
        return ResponseEntity.ok(LoginResponse.builder()
                ...
                .userUuid(tokenData.get("userUuid"))
