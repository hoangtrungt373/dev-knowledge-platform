...
Checker, Unix Time Converter, HTML Preview, Markdown Preview, and HTML to TSX
...
sanitization, since its output is plain text, never rendered; the three `OperationGroup.WEB`
operations). This list has grown well
